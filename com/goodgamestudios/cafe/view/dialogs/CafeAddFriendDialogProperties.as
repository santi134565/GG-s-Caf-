package com.goodgamestudios.cafe.view.dialogs
{
   ...
   public class CafeAddFriendDialogProperties extends BasicDialogProperties
   {
      ...
      public function CafeAddFriendDialogProperties(param1:String, param2:String, param3:int, param4:String = "Yes", param5:String = "No")
      {
