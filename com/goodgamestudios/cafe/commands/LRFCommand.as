package com.goodgamestudios.cafe.commands
{
   ...
   public class LRFCommand extends CafeCommand
   {
       
      
      public function LRFCommand()
      {
         super();
      }
      ...
      {
         return BasicSmartfoxConstants.S2C_REGISTER_FACEBOOK;
      }
      ...
      override public function executeCommand(param1:int, param2:Array) : Boolean
      {
         ...
         {
            case 0:
               layoutManager.hidePanel(CafeAvatarCreationDialog.NAME);
