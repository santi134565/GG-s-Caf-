package com.google.analytics.campaign
{
   ...
   public class CampaignManager
   {
      ...
      public function getCampaignInformation(param1:String, param2:Boolean) : CampaignInfo
      {
         ...
         {
            if((_loc6_ = this.hasNoOverride(param1)) && !this._buffer.hasUTMZ())
            {
               return _loc3_;
            }
         }
         ...
         {
            (_loc8_ = new CampaignTracker()).fromTrackerString(this._buffer.utmz.campaignTracking);
