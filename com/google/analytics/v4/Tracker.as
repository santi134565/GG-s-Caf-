   ...
   public class Tracker implements GoogleAnalyticsAPI
   {
         ...
         if(this._adSense.gaGlobal && this._adSense.dh == String(this._domainHash))
         {
            ...
            if(this._isNewVisitor)
            {
               ...
               if(this._adSense.vid)
               {
                  ...
                  if(this._debug.verbose)
                  {
                     _loc4_ = (_loc4_ = (_loc4_ = (_loc4_ = "") + "AdSense vid found (new visitor)\n") + ("Override sessionId(" + this._buffer.utma.sessionId + ") from AdSense vid(" + Number(_loc3_[0]) + ")\n")) + ("Override firstTime(" + this._buffer.utma.firstTime + ") from AdSense vid(" + Number(_loc3_[1]) + ")");
      ...
      private function _trackMetrics(param1:String = "") : void
      {
         ...
         if(this._takeSample())
         {
            ...
            {
               _loc3_ = (_loc5_ = new EventInfo(false,this._x10Module)).toVariables();
            }
      ...
      public function addItem(param1:String, param2:String, param3:String, param4:String, param5:Number, param6:int) : void
      {
         ...
         if((_loc7_ = this._ecom.getTransaction(param1)) == null)
         {
